...
class HebrewWordTokenizer:
    def tokenize(self, text):
        ...
        print(text)
        print(str(ht.tokenize(text)))
        return ht.tokenize(text)
...
class Tokenizer(object):
    ...
    @staticmethod
    def _is_word(word):
        return bool(Tokenizer._WORD_PATTERN.match(str(word)))
