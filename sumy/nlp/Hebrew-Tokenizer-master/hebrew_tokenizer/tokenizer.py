...
class Tokenizer:
    def __init__(self, flags=0, with_whitespaces=False):
        ...
        if PYTHON_VERSION_LESS_THAN_3:
            ...
            for group, (phrase, name) in enumerate(self.lexicon, 1):
                p.append(SubPattern(s, [(SUBPATTERN, (group, parse(phrase, flags))), ])) # append subpattern
    ...
    def tokenize(self, string):
        ...
        while start_idx < string_len:
            ...
            for m in matches:
                ...
                if grp_name:
                    if grp_name == self.groups.WHITESPACE and not self.with_whitespaces:
                        ...
                        wordlist.append(word) # append the word
                        print(word)
                        yield wordlist
                        token_num += 1
            ...
            wordlist.append("unknown") # when the token is unknown
            yield wordlist
            token_num += 1
            start_idx = end_idx
