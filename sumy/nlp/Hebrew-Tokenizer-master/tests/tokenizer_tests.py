...
def hebrew(print_results=False):
    ...
    s2_gt = [(u'אנשים', Groups.HEBREW), (u'שהולכים', Groups.HEBREW), (u'בשבת', Groups.HEBREW), 
             ...
             (u'קפה', Groups.HEBREW), (u'.', Groups.PUNCTUATION), (u'נקודה', Groups.HEBREW)] # generate sentences and tokens
...
def dates(print_results=False):
    ...
    s1_gt = [(u'אני', Groups.HEBREW), (u'מודד', Groups.HEBREW), (u'אורך', Groups.HEBREW), 
             (u'בס"מ', Groups.HEBREW), (u'ונפח', Groups.HEBREW), (u'בסמ"ק', Groups.HEBREW), 
             (u'בתאריך', Groups.HEBREW), (u'10.6.2020', Groups.DATE), (u'.', Groups.PUNCTUATION)]

    s2 = u'לחשוב - Never tried that before 10/06/2020.'
    s2_gt = [(u'לחשוב', Groups.HEBREW), (u'-', Groups.PUNCTUATION), (u'Never', Groups.ENGLISH), 
             (u'tried', Groups.ENGLISH), (u'that', Groups.ENGLISH), (u'before', Groups.ENGLISH),
             (u'10/06/2020', Groups.DATE), (u'.', Groups.PUNCTUATION)]
